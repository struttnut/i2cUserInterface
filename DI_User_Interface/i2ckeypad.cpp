 ...
 *				  2016 Tisham Dhar <whatnickd@gmail.com> (Ported to Arduino 1.6.8)
 *  All rights reserved.
 *
...
*DCS added - long key press functionality, constructors that don't require input, key_states
*
*
*
 */
...
unsigned long LongPressTimer = 1000;
...
void i2ckeypad::init(int addr, int r, int c)
{
...
char i2ckeypad::get_key()
{
  ...
  for(r=0;r<num_cols;r++) {
	...
	else if( (millis() - startmilli) > LongPressTimer )
		{
		temp_key = longkeymap[row_select][r];
		}
